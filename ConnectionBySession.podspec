...
Pod::Spec.new do |s|
  ...
  s.description      = <<-DESC
                       ...
                       * Don't worry about the indent, we strip it!
                       DESC
  s.homepage         = "https://github.com/<GITHUB_USERNAME>/ConnectionBySession"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "hiratsukashu" => "hiratsukashu@indival.co.jp" }
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/ConnectionBySession.git", :tag => s.version.to_s }
